...
from code_rag.models import ChangedFile, GitLabProject, PermissionRecord, SearchRequest
...
def index_project(
    ...
    repo_path_with_namespace: str | None = typer.Option(None, help="GitLab namespace/project path."),
...
def webhook_payload_changes(path: str) -> None:
    ...
    changes = [
        ChangedFile(
            ...
            modified=not any([item.get("new_file"), item.get("deleted_file"), item.get("renamed_file")]),
        )
